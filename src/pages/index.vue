            ...
            <li class="menu-item">
              ...
              <div class="children">
                <ul>
                  <li>
                    <a href id>
                      <img src="/imgs/item-box-1.png" alt />小米CC9
                    </a>
                  </li>
                  <li>
                    <a href id>
                      <img src="/imgs/item-box-2.png" alt />小米8 青春版
                    </a>
                  </li>
                  <li>
                    <a href id>
                      <img src="/imgs/item-box-3.jpg" alt />Redmi K20 Pro
                    </a>
                  </li>
                  <li>
                    <a href id>
                      <img src="/imgs/item-box-4.jpg" alt />移动4G+专区
                    </a>
                  </li>
                </ul>
                <ul>
                  <li>
                    <a href id>
                      <img src="/imgs/item-box-1.png" alt />小米CC美图定制版
                    </a>
                  </li>
                  <li>
                    <a href id>
                      <img src="/imgs/item-box-1.png" alt />小米8 屏幕指纹版
                    </a>
                  </li>
                  <li>
                    <a href id>
                      <img src="/imgs/item-box-1.png" alt />Redmi K20
                    </a>
                  </li>
                  <li>
                    <a href id>
                      <img src="/imgs/item-box-1.png" alt />小米移动 电话卡
                    </a>
                  </li>
                </ul>
                <ul v-for="index in 4" :key="index">
                  <li v-for="item in 4" :key="item">
                    <a href id> <img src="/imgs/item-box-1.png" alt />小米9 </a>
                  </li>
                </ul>
              </div>
            </li>
